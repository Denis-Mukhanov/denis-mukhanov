...
| [*интенсив* Регулярные выражения](https://github.com/Denis-Mukhanov/regex_vin) | Использование регулярных выражений для анализа данных и автоматизации процессов обработки информации | Jupyter Notebook, Python - *Pandas, NumPy, Re* | Завершен |
